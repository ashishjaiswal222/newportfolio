...
var L = (e, t, n) => jt(e, typeof t != "symbol" ? t + "" : t, n), Wt = (e, t, n) => t.has(e) || Ge("Cannot " + n);
...
import P, { createContext as Be, useContext as Te, useEffect as V, useState as w, useCallback as f, useMemo as M, useRef as N, useSyncExternalStore as Se, useLayoutEffect as qt, forwardRef as $t, useImperativeHandle as Kt, useReducer as Xt } from "react";
import { jsxs as v, Fragment as S, jsx as i } from "react/jsx-runtime";
import { useFloating as Le, useTransitionStyles as _e, useDismiss as Yt, useInteractions as Jt, offset as G, shift as ue, flip as W, size as Ee, FloatingPortal as Qt } from "@floating-ui/react";
import { BlockNoteEditor as en, BlockNoteSchema as tn, defaultStyleSpecs as nn, createBlockSpecFromStronglyTypedTiptapNode as on, createStronglyTypedTiptapNode as Re, defaultBlockSpecs as rn, mergeCSSClasses as _, filenameFromURL as ze, formatKeyboardShortcut as me, VALID_LINK_PROTOCOLS as ln, DEFAULT_LINK_PROTOCOL as cn, isTableCellSelection as an, checkBlockIsFileBlock as J, checkBlockIsFileBlockWithPlaceholder as Q, checkBlockIsFileBlockWithPreview as sn, checkBlockHasDefaultProp as Me, mapTableCell as K, checkBlockTypeHasDefaultProp as $, getDefaultEmojiPickerItems as dn, getDefaultSlashMenuItems as un, filterSuggestionItems as mn, EMPTY_CELL_WIDTH as hn, EMPTY_CELL_HEIGHT as gn, isTableCell as X, getColspan as lt, getRowspan as ct, getBlockFromPos as fn, applyNonSelectableBlockFix as bn, wrapInBlockStructure as Cn, getParseRules as pn, propsToAttributes as at, createInternalBlockSpec as kn, inheritedProps as wn, camelToDataKebab as st, audioParse as vn, audioBlockConfig as Hn, fileParse as Mn, fileBlockConfig as yn, imageParse as xn, imageBlockConfig as Vn, getPageBreakSlashMenuItems as Bn, videoParse as Tn, videoBlockConfig as Sn, defaultToggledState as ne, UnreachableCaseError as dt, nodeToCustomInlineContent as je, inlineContentToNodes as Ln, addInlineContentAttributes as _n, getInlineContentParseRules as En, addInlineContentKeyboardShortcuts as Rn, createInternalInlineContentSpec as In, addStyleAttributes as Nn, getStyleParseRules as Pn, stylePropsToAttributes as Zn, createInternalStyleSpec as Dn } from "@blocknote/core";
import { createPortal as he, flushSync as ut } from "react-dom";
import { ReactNodeViewRenderer as mt, useReactNodeView as ht, NodeViewWrapper as gt, Mark as On } from "@tiptap/react";
import { createRoot as Fn } from "react-dom/client";
const ft = Be(void 0);
function D(e) {
  return Te(ft);
}
...
function U(e, t, n, o) {
  ...
  }, m = Yt(c, h), { getReferenceProps: g, getFloatingProps: H } = Jt([m]);
  return V(() => {
    l();
  }, [t, l]), V(() => {
    t !== null && (t instanceof HTMLElement || Gn(t) ? r.setReference(t) : r.setReference({
...
const Ie = (e) => {
  ...
  Re(
    rn.paragraph.implementation.node.config
  ),
  // disable default props on paragraph (such as textalignment and colors)
  {}
), { textColor: $i, backgroundColor: Ki, ...jn } = nn, Ne = tn.create({
  blockSpecs: {
    paragraph: zn
  },
  styleSpecs: jn
...
function Wn() {
  ...
  const t = e.comments, n = p(), o = y(), r = fe({
    trailingBlock: !1,
    dictionary: {
      ...o,
      placeholders: {
...
const qn = (e) => {
  ...
  const o = Z(n.onUpdate.bind(n)), r = An(o == null ? void 0 : o.pendingComment), { isMounted: l, ref: c, style: s, getFloatingProps: d } = U(
    (o == null ? void 0 : o.pendingComment) || !1,
    r || null,
    5e3,
    {
      placement: "bottom",
      middleware: [G(10), ue(), W()],
      onOpenChange: (u) => {
...
var bt = {
  ...
  style: void 0,
  attr: void 0
}, We = P.createContext && /* @__PURE__ */ P.createContext(bt), $n = ["attr", "size", "title"];
function Kn(e, t) {
  if (e == null) return {};
  var n = Xn(e, t), o, r;
...
function Yn(e, t, n) {
  return t = Jn(t), t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e;
}
function Jn(e) {
  var t = Qn(e, "string");
...
function k(e) {
  return (t) => /* @__PURE__ */ P.createElement(eo, ie({
    attr: le({}, e.attr)
  }, t), Ct(e.child));
}
function eo(e) {
...
function Ro(e) {
  ...
  return n.current && n.current.update(e), V(() => ((async () => {
...
`)}`
  ...
  }, [t.id, a]), x = Io(d, e.userId);
  if (!e.body)
    return null;
  let T;
  const I = a.auth.canAddReaction(e), A = a.auth.canDeleteComment(e), j = a.auth.canUpdateComment(e), O = n && (t.resolved ? a.auth.canUnresolveThread(t) : a.auth.canResolveThread(t));
  c || (T = /* @__PURE__ */ v(
      ...
      children: [
        ...
        O && (t.resolved ? /* @__PURE__ */ i(
          l.Generic.Toolbar.Button,
          {
            ...
            variant: "compact",
            onClick: B,
            children: /* @__PURE__ */ i(to, { size: 16 })
          },
          "reopen"
        ) : /* @__PURE__ */ i(
          l.Generic.Toolbar.Button,
          {
            ...
            variant: "compact",
            onClick: b,
            children: /* @__PURE__ */ i(xo, { size: 16 })
          },
          "resolve"
        )),
        (A || j) && /* @__PURE__ */ v(l.Generic.Menu.Root, { position: "bottom-start", children: [
          /* @__PURE__ */ i(l.Generic.Menu.Trigger, { children: /* @__PURE__ */ i(
            l.Generic.Toolbar.Button,
            {
              mainTooltip: o.comments.actions.more_actions,
              variant: "compact",
              children: /* @__PURE__ */ i(Lo, { size: 16 })
            },
            "more-actions"
          ) }),
    ...
    l.Comments.Comment,
    {
      ...
      children: /* @__PURE__ */ i(
        Ie,
        {
          ...
          editor: r,
          editable: c,
          actions: e.reactions.length > 0 || c ? ({ isEmpty: E }) => /* @__PURE__ */ v(S, { children: [
  ...
  const n = p(), o = y(), r = C(), l = De(r, e.resolvedBy ? [e.resolvedBy] : []), c = e.comments.map((s, d) => /* @__PURE__ */ i(
    Po,
    {
      thread: e,
      comment: s,
...
const Do = (e) => {
  ...
  ), { isMounted: o, ref: r, style: l, getFloatingProps: c, setReference: s } = U(!!(n != null && n.selectedThreadId), null, 5e3, {
    placement: "bottom",
    middleware: [G(10), ue(), W()],
    onOpenChange: (h) => {
      var m;
  ...
  }, [t, d, n == null ? void 0 : n.selectedThreadId]), qt(d, [d]);
  const a = _t(t);
  ...
  const t = p(), n = y(), { block: o } = e, r = C(), [l, c] = w(""), s = f(
    (u) => {
  ...
  var h;
  const t = p(), n = y(), { block: o, setLoading: r } = e, l = C(), [c, s] = w(!1);
  V(() => {
    c && setTimeout(() => {
      s(!1);
    }, 3e3);
  ...
  const t = p(), n = y(), o = C(), [r, l] = w(!1), c = e.tabs ?? [
    ...o.uploadFile !== void 0 ? [
      {
        name: n.file_panel.upload.title,
        tabPanel: /* @__PURE__ */ i(Fo, { block: e.block, setLoading: l })
      }
    ] : [],
    {
      name: n.file_panel.embed.title,
      tabPanel: /* @__PURE__ */ i(Oo, { block: e.block })
    }
  ], [s, d] = w(
  ...
  ), { isMounted: o, ref: r, style: l, getFloatingProps: c } = U(
  ...
  if (!o || !n)
    return null;
  const { show: s, referencePos: d, ...a } = n, u = e.filePanel || Et;
...
const re = (e) => {
  ...
  if (!M(() => r ? !!l.find((h) => h.content !== void 0) : !1, [r, l]) || !o.isEditable)
    return null;
  const u = zo[e.basicTextStyle];
  return /* @__PURE__ */ i(
...
const Wo = () => {
  const e = p(), t = y(), n = C(), o = Qe("text", n), r = Qe("background", n), l = R(n), [c, s] = w(
  ...
  const t = p(), n = y(), { url: o, text: r, editLink: l, showTextField: c } = e, [s, d] = w(o), [a, u] = w(r);
  V(() => {
    d(o), u(r);
  }, [r, o]);
  const h = f(
...
const $o = () => {
  var H;
  const e = C(), t = p(), n = y(), o = qo(e), r = R(e), [l, c] = w(!1), [s, d] = w(e.getSelectedLinkUrl() || ""), [a, u] = w(e.getSelectedText());
  z(() => {
    u(e.getSelectedText() || ""), d(e.getSelectedLinkUrl() || "");
  }, e), V(() => {
    var B;
    const b = (x) => {
      (x.ctrlKey || x.metaKey) && x.key === "k" && (c(!0), x.preventDefault());
    };
    return (B = e.prosemirrorView) == null || B.dom.addEventListener("keydown", b), () => {
      var x;
      (x = e.prosemirrorView) == null || x.dom.removeEventListener("keydown", b);
    };
  ...
  const e = y(), t = p(), n = C(), [o, r] = w(), l = R(n), c = M(() => {
    if (l.length !== 1)
      return;
    const a = l[0];
    if (J(a, n))
  ...
  const e = y(), t = p(), n = C(), o = R(n), [r, l] = w(!1);
  V(() => {
    l(!1);
  }, [o]);
  ...
  return c === void 0 || !J(c, n) || !n.isEditable ? null : /* @__PURE__ */ v(t.Generic.Popover.Root, { opened: r, position: "bottom", children: [
    ...
    /* @__PURE__ */ i(
      t.Generic.Popover.Content,
      {
        ...
        children: /* @__PURE__ */ i(Et, { block: c })
      }
    )
  ] });
}, Qo = () => {
  const e = y(), t = p(), n = C(), o = R(n), [r, l] = w(
    () => n.canNestBlock()
  );
  z(() => {
    l(n.canNestBlock());
  ...
  const t = p(), n = y(), o = C(), r = R(o), [l, c] = w(o.getTextCursorPosition().block), s = M(() => (e.items || tr(n)).filter(
...
const ir = () => {
  ...
  return !n.isEditable || r === void 0 || !n.settings.tables.splitCells ? null : /* @__PURE__ */ i(
    t.FormattingToolbar.Button,
    {
      ...
      icon: r === "horizontal" ? /* @__PURE__ */ i(fo, {}) : /* @__PURE__ */ i(bo, {}),
      onClick: l
    }
  );
}, ar = {
  ...
  /* @__PURE__ */ i(nr, { items: e }, "blockTypeSelect"),
  /* @__PURE__ */ i(cr, {}, "tableCellMergeButton"),
  /* @__PURE__ */ i(Ko, {}, "fileCaptionButton"),
  /* @__PURE__ */ i(Jo, {}, "replaceFileButton"),
  /* @__PURE__ */ i(Yo, {}, "fileRenameButton"),
  /* @__PURE__ */ i(Xo, {}, "fileDeleteButton"),
  /* @__PURE__ */ i(ir, {}, "fileDownloadButton"),
  /* @__PURE__ */ i(lr, {}, "filePreviewButton"),
  ...
  /* @__PURE__ */ i(Wo, {}, "colorStyleButton"),
  /* @__PURE__ */ i(Qo, {}, "nestBlockButton"),
  /* @__PURE__ */ i(er, {}, "unnestBlockButton"),
  /* @__PURE__ */ i($o, {}, "createLinkButton"),
  /* @__PURE__ */ i(or, {}, "addCommentButton"),
  /* @__PURE__ */ i(rr, {}, "addTiptapCommentButton")
], It = (e) => {
  const t = p();
  return /* @__PURE__ */ i(
  ...
  ), { isMounted: c, ref: s, style: d, getFloatingProps: a } = U(
    ...
    3e3,
    {
      ...
      canDismiss: {
        ...
        outsidePress: (m) => {
          ...
          return !g || !m.target ? !1 : !Go(m, g.dom.parentElement);
        }
      },
      ...e.floatingOptions
    }
  ...
  return e.children ? /* @__PURE__ */ i(t.LinkToolbar.Root, { className: "bn-toolbar bn-link-toolbar", children: e.children }) : /* @__PURE__ */ v(
    t.LinkToolbar.Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(hr, { url: e.url }),
        /* @__PURE__ */ i(ur, { deleteLink: e.deleteLink })
      ]
    }
  );
}, fr = (e) => {
  ...
  ), { isMounted: r, ref: l, style: c, getFloatingProps: s } = U(
  ...
  if (!r || !o)
    return null;
  const { show: d, referencePos: a, ...u } = o, h = e.linkToolbar || gr;
...
const Cr = (e) => {
  ...
  return /* @__PURE__ */ i(
    t.SideMenu.Button,
    {
      ...
      icon: /* @__PURE__ */ i(br, { size: 24, onClick: r, "data-test": "dragHandleAdd" })
    }
  );
};
function Nt(e) {
  ...
  return /* @__PURE__ */ i(
    t.Generic.Menu.Dropdown,
    {
      ...
      children: e.children || /* @__PURE__ */ v(S, { children: [
        /* @__PURE__ */ i(wr, { ...e, children: n.drag_handle.delete_menuitem }),
        /* @__PURE__ */ i(kr, { ...e, children: n.drag_handle.colors_menuitem }),
        /* @__PURE__ */ i(vr, { ...e, children: n.drag_handle.header_row_menuitem }),
        /* @__PURE__ */ i(Hr, { ...e, children: n.drag_handle.header_column_menuitem })
      ] })
    }
  );
}, yr = (e) => {
  const t = p(), n = y(), o = e.dragHandleMenu || Mr;
  return /* @__PURE__ */ v(
    t.Generic.Menu.Root,
    {
      onOpenChange: (r) => {
...
function Tr(e) {
  const t = p(), n = y(), { items: o, loadingState: r, selectedIndex: l, onItemClick: c, columns: s } = e, d = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ i(
...
function Zt(e, t) {
  const [n, o] = w([]), [r, l] = w(!1), c = N(void 0), s = N(void 0);
  return V(() => {
    const d = e;
...
function _r(e) {
  const t = C(), {
    ...
    [t.suggestionMenus, n]
  ), g = Z(m), { isMounted: H, ref: b, style: B, getFloatingProps: x } = U(
  ...
  return !H || !g || !(g != null && g.ignoreQueryLength) && l && (g.query.startsWith(" ") || g.query.length < l) ? null : /* @__PURE__ */ i("div", { ref: b, style: B, ...x(), children: /* @__PURE__ */ i(
    Lr,
    {
      query: g.query,
      ...
      getItems: u,
      columns: r,
      gridSuggestionMenuComponent: o || Tr,
      onItemClick: a
    }
  ) });
}
function Er(e) {
  const t = p(), n = y(), { items: o, loadingState: r, selectedIndex: l, onItemClick: c } = e, s = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ i(
...
function Rr(e, t) {
  ...
  return {
    ...
    handler: (r) => {
      ...
      const l = Ir(r) ? r.nativeEvent.isComposing : r.isComposing;
...
function Nr(e, t, n, o, r) {
  const { selectedIndex: l, setSelectedIndex: c, handler: s } = Rr(n, o);
  return V(() => {
    var d;
...
function Or(e) {
  const t = C(), {
    ...
    [t.suggestionMenus, n]
  ), m = Z(h), { isMounted: g, ref: H, style: b, getFloatingProps: B } = U(
    ...
    2e3,
    {
      ...
      middleware: [
        ...
        ue(),
        Ee({
          apply({ availableHeight: x, elements: T }) {
...
const Fr = (e, t = 0.3) => {
  ...
  return V(() => {
  ...
  }, [o, e.block, e.editor, e.orientation]), V(() => {
  ...
  }, [o, e.onMouseUp]), e.editor.isEditable ? /* @__PURE__ */ i(
    t.TableHandle.ExtendButton,
    {
      ...
      onClick: c,
      onMouseDown: l,
      children: e.children || /* @__PURE__ */ i(yo, { size: 18, "data-test": "extendButton" })
    }
  ) : null;
}, nt = (e) => {
  ...
  const t = p(), n = y(), o = C(), r = o.tableHandles, l = M(() => !r || !e.block ? [] : e.orientation === "row" ? r.getCellsAtRowHandle(e.block, e.index) : r.getCellsAtColumnHandle(e.block, e.index), [e.block, e.index, e.orientation, r]), c = (d, a) => {
  ...
  const t = p(), [n, o] = w(!1), r = e.tableHandleMenu || Wr, l = M(() => {
...
function ve(e, t, n, o, r) {
  ...
  return V(() => {
    ...
    r && e === "cell" || l.setReference({
      getBoundingClientRect: () => (e === "row" ? Kr : e === "col" ? Xr : Yr)(n, o, r)
    });
  }, [r, e, n, o, l]), M(
    () => ({
      isMounted: a,
...
const Qr = (e) => {
  ...
  var l, c;
  const t = p(), n = y(), o = C(), r = (c = (l = e.block.content.rows[e.rowIndex]) == null ? void 0 : l.cells) == null ? void 0 : c[e.colIndex];
  ...
  const t = p(), n = e.tableCellMenu || ti;
  return !e.editor.settings.tables.splitCells && !e.editor.settings.tables.cellBackgroundColor && !e.editor.settings.tables.cellTextColor ? null : /* @__PURE__ */ v(
    t.Generic.Menu.Root,
    {
      ...
      position: "right",
      children: [
        /* @__PURE__ */ i(t.Generic.Menu.Trigger, { children: /* @__PURE__ */ i(t.Generic.Menu.Button, { className: "bn-table-cell-handle", children: e.children || /* @__PURE__ */ i(pr, { size: 12, "data-test": "tableCellHandle" }) }) }),
        he(
          /* @__PURE__ */ i(
            n,
            {
  ...
  if (!a)
    return null;
  const A = e.tableHandle || qr, j = e.extendButton || Ar, O = e.tableCellHandle || ni;
  return /* @__PURE__ */ v(S, { children: [
    /* @__PURE__ */ i("div", { ref: o }),
    /* @__PURE__ */ v(Qt, { root: a.widgetContainer, children: [
...
function ri(e) {
  ...
  return /* @__PURE__ */ v(S, { children: [
    e.formattingToolbar !== !1 && /* @__PURE__ */ i(dr, {}),
    e.linkToolbar !== !1 && /* @__PURE__ */ i(fr, {}),
    e.slashMenu !== !1 && /* @__PURE__ */ i(Or, { triggerCharacter: "/" }),
    ...
    e.sideMenu !== !1 && /* @__PURE__ */ i(Vr, {}),
    t.filePanel && e.filePanel !== !1 && /* @__PURE__ */ i(Ao, {}),
    t.tableHandles && e.tableHandles !== !1 && /* @__PURE__ */ i(oi, {}),
...
function di(e, t) {
  const {
    ...
    ...I
  } = e, [A, j] = w(), O = D(), q = ii(), E = (O == null ? void 0 : O.colorSchemePreference) || q, F = r || (E === "dark" ? "dark" : "light");
  ee(d || rt, n), ge(s || rt, n), V(() => {
    n.isEditable = c !== !1;
  }, [c, n]);
  const te = f(
    (Ut) => {
      n.elementRenderer = Ut;
    },
    [n]
  ), At = M(() => ({
    ...O,
  ...
  return /* @__PURE__ */ i(ft.Provider, { value: At, children: /* @__PURE__ */ v(Dt.Provider, { value: Gt, children: [
    /* @__PURE__ */ i(si, { ref: te }),
    /* @__PURE__ */ i(
      ui,
      {
        className: o,
...
const ui = P.forwardRef(({ className: e, renderEditor: t, editorColorScheme: n, children: o, ...r }, l) => /* @__PURE__ */ i(
  "div",
  {
    ...
    ...r,
    ref: l,
    children: t ? /* @__PURE__ */ i(mi, { children: o }) : o
  }
)), Xi = P.forwardRef(di), mi = (e) => {
  const t = li(), n = C(), o = M(() => ci(), []), r = f(
    (l) => {
      n.mount(l, o);
    },
    [n, o]
  ...
  return /* @__PURE__ */ v(S, { children: [
    /* @__PURE__ */ i(ai, { contentComponent: o }),
    /* @__PURE__ */ i(hi, { ...t.editorProps, ...e, mount: r }),
    /* @__PURE__ */ i(ri, { ...t.defaultUIProps }),
    e.children
  ] });
}, hi = (e) => {
      ...
      gt,
      {
        ...
        ...Object.fromEntries(
          Object.entries(e.blockProps).filter(([n, o]) => {
            ...
            return !wn.includes(n) && o !== r.default;
          }).map(([n, o]) => [st(n), o])
        ),
    ...
    addNodeView() {
      return (o) => {
        const r = mt(
          (l) => {
            var h;
            const c = this.options.editor, s = fn(
              l.getPos,
              c,
              this.editor,
              e.type
        ...
        return e.isSelectable === !1 && bn(r, this.editor), r;
      };
    }
  });
  return kn(e, {
...
function gi(e) {
  const t = C();
  V(() => t.onUploadEnd(e), [e, t]);
}
function fi(e) {
  const t = C();
  V(() => t.onUploadStart(e), [e, t]);
}
function Ot(e) {
  const [t, n] = w(!1);
  return fi((o) => {
...
const Ti = (e) => {
  ...
  Ft,
  {
    ...
    buttonIcon: /* @__PURE__ */ i(Mo, { size: 24 }),
    children: /* @__PURE__ */ i(Ti, { ...e })
  }
), tl = Ce(Sn, {
  render: Li,
  parse: Tn,
  ...
  const { block: t, editor: n, children: o, toggledState: r } = e, [l, c] = Xt(
    _i,
    (r || ne).get(t)
...
function rl(e) {
  ...
  const n = Z(
    t.comments.onUpdate.bind(t.comments)
  ), o = n == null ? void 0 : n.selectedThreadId, r = _t(t), l = M(() => {
    const c = Array.from(r.values()), s = Ri(
      c,
      e.sort || "position",
...
function il(e) {
  ...
  const n = e, [o, r] = w(() => n.getActiveStyles()), l = f(() => {
    r(n.getActiveStyles());
  }, [n]);
  return ee(l, n), ge(l, n), o;
}
function Ii() {
  const [, e] = w(0);
  return () => e((t) => t + 1);
...
export {
  Cr as AddBlockButton,
  nt as AddButton,
  or as AddCommentButton,
  bi as AddFileButton,
  rr as AddTiptapCommentButton,
  wi as AudioBlock,
  pi as AudioPreview,
  ki as AudioToExternalHTML,
  re as BasicTextStyleButton,
  kr as BlockColorsItem,
  He as BlockContentWrapper,
  ft as BlockNoteContext,
  ri as BlockNoteDefaultUI,
  mi as BlockNoteViewEditor,
  Xi as BlockNoteViewRaw,
  nr as BlockTypeSelect,
  Qr as ColorPickerButton,
  Wo as ColorStyleButton,
  Po as Comment,
  Zo as Comments,
  Un as ComponentsContext,
  $o as CreateLinkButton,
  Gr as DeleteButton,
  ur as DeleteLinkButton,
  yr as DragHandleButton,
  Mr as DragHandleMenu,
  mr as EditLinkButton,
  Rt as EditLinkMenuItems,
  Oo as EmbedTab,
  ol as ExperimentalMobileFormattingToolbarController,
  Ar as ExtendButton,
  Fe as FigureWithCaption,
  Hi as FileBlock,
  Ae as FileBlockWrapper,
  Ko as FileCaptionButton,
  Xo as FileDeleteButton,
  ir as FileDownloadButton,
  Ci as FileNameWithIcon,
  Et as FilePanel,
  Ao as FilePanelController,
  lr as FilePreviewButton,
  Yo as FileRenameButton,
  Jo as FileReplaceButton,
  vi as FileToExternalHTML,
  Wn as FloatingComposer,
  qn as FloatingComposerController,
  Do as FloatingThreadController,
  It as FormattingToolbar,
  dr as FormattingToolbarController,
  _r as GridSuggestionMenuController,
  Lr as GridSuggestionMenuWrapper,
  xi as ImageBlock,
  Mi as ImagePreview,
  yi as ImageToExternalHTML,
  Pi as InlineContentWrapper,
  gr as LinkToolbar,
  fr as LinkToolbarController,
  pe as LinkWithCaption,
  Qo as NestBlockButton,
  hr as OpenLinkButton,
  Yi as ReactAudioBlock,
  Ji as ReactFileBlock,
  Qi as ReactImageBlock,
  tl as ReactVideoBlock,
  wr as RemoveBlockItem,
  Ft as ResizableFileBlockWrapper,
  xr as SideMenu,
  Vr as SideMenuController,
  ei as SplitButton,
  Or as SuggestionMenuController,
  Pr as SuggestionMenuWrapper,
  ni as TableCellButton,
  ti as TableCellMenu,
  cr as TableCellMergeButton,
  Hr as TableColumnHeaderItem,
  qr as TableHandle,
  Wr as TableHandleMenu,
  oi as TableHandlesController,
  vr as TableRowHeaderItem,
  we as TextAlignButton,
  Lt as Thread,
  rl as ThreadsSidebar,
  nl as ToggleWrapper,
  er as UnnestBlockButton,
  Fo as UploadTab,
  Li as VideoBlock,
  Ti as VideoPreview,
  Si as VideoToExternalHTML,
  tr as blockTypeSelectItems,
  Ce as createReactBlockSpec,
  al as createReactInlineContentSpec,
  sl as createReactStyleSpec,
  dl as elementOverflow,
  Br as getDefaultReactEmojiPickerItems,
  Dr as getDefaultReactSlashMenuItems,
  sr as getFormattingToolbarItems,
  el as getPageBreakReactSlashMenuItems,
  it as getReferenceText,
  Uo as mergeRefs,
  il as useActiveStyles,
  qi as useBlockNote,
  ...
  ll as useEditorForceUpdate,
  An as useEditorSelectionBoundingBox,
  ge as useEditorSelectionChange,
  $r as useExtendButtonsPositioning,
  cl as useFocusWithin,
  Sr as useGridSuggestionMenuKeyboardNavigation,
  Zt as useLoadSuggestionMenuItems,
  gi as useOnUploadEnd,
  fi as useOnUploadStart,
  ii as usePrefersColorScheme,
  Oe as useResolveUrl,
  R as useSelectedBlocks,
  Rr as useSuggestionMenuKeyboardHandler,
  Nr as useSuggestionMenuKeyboardNavigation,
  Jr as useTableHandlesPositioning,
  _t as useThreads,
  U as useUIElementPositioning,
